...
-export([
  ...
  get_role_list_by_accid_account/2,
  get_role_list_by_accid_account_serverid/3,

  get_role_count_by_accid_account/2,
  get_role_count_by_accid_account_server/3,


  daily_clear/0,
  recharge/2,
  add_total_recharge/2,
  present_gold/2,
  get_players_by_lv/1,
  update_guild_id/3,
  add_coin/2,
...
create_role(Player) ->
  ...
  {insert, _, _} = ?DB_GAME:insert(player, FieldList, ValueList),
  ok.
